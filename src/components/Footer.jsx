...
const Footer = () => {
  return (
    ...
    <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 bg-[#E4EEF8]">
    <div className="flex flex-col md:flex-row justify-between gap-10 border-b border-gray-500/30 px-6 md:px-16 lg:px-24 xl:px-32 pb-6 max-w-[1440px] w-full mx-auto">
        <div className="md:max-w-96">
            <img className="h-9 invert" src={assets.logo2} alt="dummyLogoDark"/>
